...
- `fetch_user_squad(team_id: int, gameweek: int)` — Fetch a user's current squad. **Gated** — see the squad section below; do not call when a squad has already been loaded.

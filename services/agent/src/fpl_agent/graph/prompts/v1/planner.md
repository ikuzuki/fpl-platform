...
- `fetch_user_squad(team_id: int, gameweek: int)` — Fetch a user's current squad. Only call this if the question refers to "my team" / "my squad" and a ``team_id`` has been provided in context.

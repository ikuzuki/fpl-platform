...
def sample_fixtures_raw() -> list[dict[str, Any]]:
    ...
    return [
        # GW31 (past)
        {
            ...
            "team_h_difficulty": 4,
            "team_a_difficulty": 4,
            "kickoff_time": "2026-04-05T15:00:00Z",
        },
        {
            "event": 31,
            "team_h": 13,
            ...
            "team_h_difficulty": 3,
            "team_a_difficulty": 4,
            "kickoff_time": "2026-04-05T17:30:00Z",
        },
        # GW32
        {
            "event": 32,
        ...
        # GW33
        {
            ...
            "team_h_difficulty": 4,
            "team_a_difficulty": 3,
            "kickoff_time": "2026-04-19T15:00:00Z",
        },
        {
            "event": 33,
            "team_h": 13,
    ...
    data = [
        {
            ...
            "expected_goal_involvements": 23.0,
            "form": 2.0,
            "points_per_game": 6.8,
            ...
            "understat_xg": 23.14,
            "understat_xa": 4.77,
            "understat_npxg": 20.09,
            "understat_npg": 19.0,
            "understat_shots": 102.0,
            "understat_key_passes": 21.0,
            "understat_xg_chain": 26.24,
        ...
        },
        {
            ...
            "bps": 795,
            "starts": 28,
            "expected_goals": 10.32,
            "expected_assists": 9.03,
            "expected_goal_involvements": 19.35,
            "form": 11.5,
            "points_per_game": 6.8,
            ...
            "news": "",
            "chance_of_playing_next_round": 100.0,
            "transfers_in_event": 156843,
            "transfers_out_event": 5157,
            "influence": 1030.4,
            "creativity": 1467.1,
            "threat": 510.0,
            "ict_index": 301.0,
            ...
            "injury_signal_risk_score": 0,
            "injury_signal_reasoning": "No data.",
            "injury_signal_injury_type": None,
            "injury_signal_sources": [],
        ...
        },
        {
            ...
            "expected_goal_involvements": 15.5,
            "form": 7.0,
            "points_per_game": 6.0,
            ...
            "understat_npxg": 8.5,
            "understat_npg": 9.0,
            "understat_shots": 60.0,
            "understat_key_passes": 40.0,
            "understat_xg_chain": 15.0,
            ...
            "injury_signal_reasoning": "Minor knock.",
        ...
        },
        {
            ...
            "injury_signal_reasoning": "Limited minutes.",
            "injury_signal_injury_type": None,
            "injury_signal_sources": [],

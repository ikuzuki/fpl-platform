...
class TestBuildFixtureTicker:
    def test_filters_past_gameweeks(
        ...
        rows, _ = build_fixture_ticker(sample_fixtures_raw, team_map, current_gw=31, season="2025-26")
    ...
    def test_fdr_lookup_structure(
        ...
        _, fdr = build_fixture_ticker(sample_fixtures_raw, team_map, current_gw=31, season="2025-26")
        assert 1 in fdr

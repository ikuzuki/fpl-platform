...
class TestBuildPlayerDashboard:
    ...
    def test_filters_non_enriched_players(
        ...
        df = pd.DataFrame([{
            "id": 999, "web_name": "Nobody", "first_name": "No", "second_name": "Body",
            "team": 1, "element_type": 2, "now_cost": 40, "total_points": 5,
            "minutes": 100, "goals_scored": 0, "assists": 0, "clean_sheets": 0,
            "goals_conceded": 5, "yellow_cards": 0, "red_cards": 0, "bonus": 0,
            "bps": 10, "starts": 1, "expected_goals": 0.0, "expected_assists": 0.0,
            "expected_goal_involvements": 0.0, "form": 0.0, "points_per_game": 0.5,
            "selected_by_percent": 0.1, "status": "a", "news": "",
            "chance_of_playing_next_round": None, "transfers_in_event": 0,
            "transfers_out_event": 0, "influence": 0.0, "creativity": 0.0,
            "threat": 0.0, "ict_index": 0.0, "season": "2025-26",
            ...
            "player_summary_form_trend": None, "player_summary_confidence": None,
            "injury_signal_risk_score": None, "injury_signal_reasoning": None,
            "injury_signal_injury_type": None, "injury_signal_sources": None,
            "sentiment_sentiment": None, "sentiment_score": None,
            "sentiment_key_themes": None, "fixture_outlook_difficulty_score": None,
            "fixture_outlook_recommendation": None, "fixture_outlook_best_gameweeks": None,
        }])
